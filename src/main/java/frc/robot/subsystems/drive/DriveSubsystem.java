...
public class DriveSubsystem extends MeasurableSubsystem {
    private final ModulesIOInputsAutoLogged inputs = new ModulesIOInputsAutoLogged();
    ...
    private final ModulesIO io;

    public DriveSubsystem(ModulesIO io) {
        this.io = io;
        swerveDrive = new SwerveDrive(io.swerveModules);
